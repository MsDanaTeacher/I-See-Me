  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/community"
          element={<Community currentUser={user} setUser={setUser} />}
        />
        <Route
          path="/searchbooks"
          element={
        ...
        <Route
          path="/profile"
          element={<Profile user={user} setUser={setUser} books={bookData} />}
        />
        <Route
          path="/bookrecommendation"
          element={<RecommendationForm user={user} setUser={setUser} />}
        />
        <Route
        ...
        />
        <Route
          path={`/followeebooklessondetails/:id/:bookid`}
